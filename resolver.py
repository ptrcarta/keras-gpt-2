...
Resolver = resolver.TPUClusterResolver
Resolver.master = mock_master
Resolver.cluster_spec = cluster_spec
#resolver.TPUClusterResolver, 'master', mock_master)
#TPUClusterResolver = mock.patch.object(TPUClusterResolver, 'cluster_spec', cluster_spec)
if 'GOOGLE_APPLICATION_CREDENTIALS' in os.environ:
    os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = ''
res = Resolver(os.environ['TPU_NAME'])
